...
SELECT * FROM Paiements INNER JOIN Clients ON ID_Client = RefClient WHERE Nom = "POUILLON" AND Prenom = "Christian";
...
SELECT * FROM Paiements INNER JOIN Clients ON ID_Client = RefClient WHERE Nom = "TARISSE" AND Prenom = "Carine";
